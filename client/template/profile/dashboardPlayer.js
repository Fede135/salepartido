Template.dashboardPlayer.helpers({	
...
Template.dashboardPlayer.events({

	'click #perfil': function (event) {

		event.preventDefault;
		Router.go('showProfile', {_id: this._id});
	},
...
Template.dashboardPlayer.onCreated(function() {
