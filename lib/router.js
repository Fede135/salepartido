...
Router.route('/abmrecintos/', {name: 'abmRecintos'});
Router.route('/cargarrecinto/', {name: 'crearRecinto'});
Router.route('/modificarrecinto/', {name: 'modificarRecinto'});
Router.route('/eliminarrecinto/', {name: 'eliminarRecinto'});
