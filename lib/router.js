...
Router.route('/showProfile/:_id',{ 
  name : 'showProfile',
  waitOn: function () {
    return Meteor.subscribe('reservasUsuario', this.params._id);
  },
  data: function() {
...
Router.route('/modificarReservaJugador/:_id', {
  ...
  waitOn: function () {
    return Meteor.subscribe('reserva', this.params._id);
  },
  data: function(){
...
Router.route('/confirmarpartido/:_id', {
  ...
  waitOn: function () {
    return Meteor.subscribe('partido', this.params._id);
  },
  data: function() {
...
Router.route('/dashboard/:_id', {
  name: 'dashboard',
  waitOn: function () {
    return Meteor.subscribe('reservasDueno', this.params._id);
  },
  data: function() { 
    return Recintos.findOne({_id: this.params._id})
  }
